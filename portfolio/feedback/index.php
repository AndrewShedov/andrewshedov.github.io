...
$form['form-2'] = array(
	'fields' => array(
		'name' => array(
			...
			'messages' => array(
				'preg' => 'Field - %1$s  may contain an error',
				'minlength' => 'Minimum field length - %1$s,  less than acceptable - %2$s',
				'maxlength' => 'Maximum field length - %1$s,  exceeds the allowable - %2$s',
			)
		),
		'tell' => array(
			'title' => 'Phone',
	...
	'cfg' => array(
		...
		'title' => 'Title in the body of the letter',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'myemail',
		'from_name' => 'myname', 
		'to_email' => 'anrisssss777@gmail.com',
		'to_name' => 'noreply1',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
		...
		'fuck' => 'Message sent - ERROR',
		'spam' => 'System - Spam! Please, re-send the message in 10-20 minutes.',
...
if(isset($form[$act])) {
   ...
   $sb = array(); // subject и body
      ...
      foreach($form['fields'] as $name => $field) {
            ...
            $rawdata = isset($_POST[$name]) ? trim($_POST[$name]) : '';
              ...
              if(isset($field['validate'])) {              
                  ...
                  $def = 'Field with name [ '.$name.' ] contains an error.';
                  // -0-
    ...
    $error[] = 'No name form settings #'.$act;
 }
